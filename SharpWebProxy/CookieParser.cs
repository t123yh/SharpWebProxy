...
namespace SharpWebProxy
{
    ...
    internal class CookieParser
    {
...
#else
        private static Func<MyCookie, string, bool> s_internalSetNameMethod;
        private static Func<MyCookie, string, bool> InternalSetNameMethod
        {
            get
            {
...
#endif
                    MethodInfo method = typeof(MyCookie).GetMethod("InternalSetName", flags);
                    Debug.Assert(method != null, "We need to use an internal method named InternalSetName that is declared on Cookie.");
                    s_internalSetNameMethod = (Func<MyCookie, string, bool>)Delegate.CreateDelegate(typeof(Func<MyCookie, string, bool>), method);
                }
        ...
        private static FieldInfo IsQuotedDomainField
        {
            get
            {
                if (s_isQuotedDomainField == null)
                {
                    ...
                    flags |= BindingFlags.NonPublic;
#endif
                    FieldInfo field = typeof(MyCookie).GetField("IsQuotedDomain", flags);
        ...
        private static FieldInfo IsQuotedVersionField
        {
            get
            {
                if (s_isQuotedVersionField == null)
                {
                    ...
                    flags |= BindingFlags.NonPublic;
#endif
                    FieldInfo field = typeof(MyCookie).GetField("IsQuotedVersion", flags);
        ...
        internal MyCookie GetServer()
        {
            MyCookie cookie = _savedCookie;
            _savedCookie = null;
